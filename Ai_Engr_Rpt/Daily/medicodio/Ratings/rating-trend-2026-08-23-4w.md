...
| ISO week | Week range (UTC) | Review dates found | Members rated | Status |
| --- | --- | --- | --- | --- |
...
- 2026-08-19: **Scoring limitations (read before using these numbers).**
- 2026-08-23: **Scope:** the 6 contributors with observable activity on the review date (of ~24 seen across the month)
- 2026-08-23: **Weekend caveat — read before comparing.** 2026-08-23 was a Sunday. These cards score the *quality* of what was done on a low-staffing day, not the day's throughput, and they are **not** a like-for-like baseline for weekday cards. Where a dimension has no evidence on the day it is marked **NR** and excluded from the weighted average.
- 2026-08-23: **CI caveat.** `globalcodio-monorepo` had **zero successful CI runs** on the review date (52 failed, 14 cancelled — GitHub Actions billing/spending-limit block, third consecutive day). Rigor scores below credit *locally run* gates and published gate logs, because automated verification was unavailable to everyone in Global Codio through no fault of theirs.

## Week-over-week movement

### 2026-W31 → 2026-W32

Not comparable: no rating card exists for 2026-W31, 2026-W32.

### 2026-W32 → 2026-W33

Not comparable: no rating card exists for 2026-W32, 2026-W33.

### 2026-W33 → 2026-W34

Not comparable: no rating card exists for 2026-W33.

## Within-week movement

### 2026-W34: 2026-08-19 → 2026-08-23 (same week)

| Member | Product | Previous | Current | Δ | Status |
| --- | --- | --- | --- | --- | --- |
| akanksh-rv | Global Codio | 6.3 | 7.1 | +0.8 | CHANGED |
...
| Member | Delivery | Rigor | Review | Devin | Automation | Consistency |
| --- | --- | --- | --- | --- | --- | --- |
| akanksh-rv | 8 → 8 | 7 → 7 | 5 → 8 | 4 → 6 | 4 → 4 | 8 → 8 |
...
| amit-pandey-medicodio | 7 → NR | 4 → NR | 3 → NR | 5 → NR | 2 → NR | 7 → NR |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SaijyotiMeti | Global Codio | 8.1 | Strong | 8 | 9 | 9 | 8 | 5 | 8 |
| anirudh-medicodio | Global Codio | 7.2 | Solid | 9 | 8 | 8 | 4 | 4 | 8 |
| Amrutha-Beedikar | Global Codio | 7.2 | Solid | 8 | 9 | 8 | 4 | 5 | 7 |
| akanksh-rv | Global Codio | 6.3 | Mixed | 8 | 7 | 5 | 4 | 4 | 8 |
| sameer-s-mansur | Medicodio | 6.2 | Mixed | 8 | 5 | NR | 4 | 6 | 8 |
| Medicodio-Amit | Medicodio | 6.1 | Mixed | 8 | 6 | 6 | 4 | 4 | 7 |
| jatinkushwaha-medicodio | Medicodio | 5.9 | Mixed | 8 | 6 | 4 | 4 | 4 | 8 |
...
| amit-pandey-medicodio | Medicodio | 4.8 | Needs Support | 7 | 4 | 3 | 5 | 2 | 7 |
...
| Member | Product | Overall | Band | Delivery | Rigor | Review | Devin | Automation | Consistency |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SaijyotiMeti | Global Codio | 7.3 | Solid | 8 | 8 | 9 | 5 | 4 | 8 |
| akanksh-rv | Global Codio | 7.1 | Solid | 8 | 7 | 8 | 6 | 4 | 8 |
| Amrutha-Beedikar | Global Codio | 6.2 | Mixed | 7 | 8 | 6 | 4 | 4 | 5 |
| sameer-s-mansur | Medicodio (integration) | 5.7 | Mixed | 7 | 7 | 3 | 4 | 4 | 7 |
| anirudh-medicodio | Global Codio | 5.4 | Mixed | 6 | 6 | 3 | 5 | 4 | 8 |
| hitesh | Medicodio (app) | 4.1 | Needs Support | 4 | 5 | 3 | 3 | 4 | 5 |
